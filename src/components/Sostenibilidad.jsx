...
function Sostenibilidad()  {
  return (
    <div className="container mt-8">
      <h1 className="text-sm">Diseñamos para ti, respetando nuestro Planeta-Hogar y las Personas.
Para nosotros es importante controlar todas las fases del proceso de producción de inicio a fin para que, cuando la prenda llegue a ti, cumpla con todos los estándares de la moda ética y sostenible.
